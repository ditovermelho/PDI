"""
A operação de Fechamento combina uma Dilatação seguida de uma Erosão. Execute o código abaixo e comente os resultados.
"""
...
# I = imread('Laboratorio_6_3.tif', as_grey=True)
I = cv2.imread('./img/Laboratorio_6_3.tif', cv2.IMREAD_GRAYSCALE)

elem_estrut_1 = disk(3)
elem_estrut_2 = rectangle(3, 12)
...
Id_1 = binary_closing(I, footprint=elem_estrut_1)
Id_2 = binary_closing(I, footprint=elem_estrut_2)
